...
class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[49152, 768]", primals_2: "f32[768]", primals_3: "f32[768]", primals_4: "f32[1152, 768]", primals_5: "f32[1152]", primals_6: "f32[768, 384]", primals_7: "f32[768]", primals_8: "f32[768]", primals_9: "f32[768]", primals_10: "f32[1536, 768]", primals_11: "f32[1536]", primals_12: "f32[768, 1536]", primals_13: "f32[768]", primals_14: "f32[768]", primals_15: "f32[768]", primals_16: "f32[49152, 768]", primals_17: "f32[1536, 768]", primals_18: "i64[8, 1536]", primals_19: "b8[8, 1, 1536, 1536]", primals_20: "i64[8, 1536]", primals_21: "i64[8, 1536]", primals_22: "f32[8, 1536]"):
        ...
        t_4: "f32[768, 49152]" = torch.ops.aten.t.default(primals_16);  primals_16 = None
        view_22: "f32[12288, 768]" = torch.ops.aten.view.default(wait_tensor_5, [12288, 768]);  wait_tensor_5 = None
        mm_4: "f32[12288, 49152]" = torch.ops.aten.mm.default(view_22, t_4);  view_22 = t_4 = None
        view_23: "f32[1536, 8, 49152]" = torch.ops.aten.view.default(mm_4, [1536, 8, 49152]);  mm_4 = None
        ...
        all_reduce_1: "f32[1536, 8]" = torch.ops._c10d_functional.all_reduce.default(getitem_20, 'max', '12')
        ...
        clone_5: "f32[1536, 8, 49152]" = torch.ops.aten.clone.default(view_23);  view_23 = None
        unsqueeze_1: "f32[1536, 8, 1]" = torch.ops.aten.unsqueeze.default(copy_3, -1);  copy_3 = None
        sub_1: "f32[1536, 8, 49152]" = torch.ops.aten.sub.Tensor(clone_5, unsqueeze_1);  clone_5 = unsqueeze_1 = None
        ...
        view_26: "f32[12288, 49152]" = torch.ops.aten.view.default(sub_1, [-1, 49152])
        ...
        copy_4: "f32[1536, 8, 49152]" = torch.ops.aten.copy.default(sub_1, exp);  sub_1 = exp = None
        sum_1: "f32[1536, 8]" = torch.ops.aten.sum.dim_IntList(copy_4, [-1])
        all_reduce_2: "f32[1536, 8]" = torch.ops._c10d_functional.all_reduce.default(view_30, 'sum', '12')
