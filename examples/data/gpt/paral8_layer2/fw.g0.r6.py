...
class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[12288, 768]", primals_2: "f32[768]", primals_3: "f32[768]", primals_4: "f32[288, 768]", primals_5: "f32[288]", primals_6: "f32[768, 96]", primals_7: "f32[768]", primals_8: "f32[768]", primals_9: "f32[768]", primals_10: "f32[384, 768]", primals_11: "f32[384]", primals_12: "f32[768, 384]", primals_13: "f32[768]", primals_14: "f32[768]", primals_15: "f32[768]", primals_16: "f32[288, 768]", primals_17: "f32[288]", primals_18: "f32[768, 96]", primals_19: "f32[768]", primals_20: "f32[768]", primals_21: "f32[768]", primals_22: "f32[384, 768]", primals_23: "f32[384]", primals_24: "f32[768, 384]", primals_25: "f32[768]", primals_26: "f32[768]", primals_27: "f32[768]", primals_28: "f32[12288, 768]", primals_29: "f32[1536, 768]", primals_30: "i64[8, 1536]", primals_31: "b8[8, 1, 1536, 1536]", primals_32: "i64[8, 1536]", primals_33: "i64[8, 1536]", primals_34: "f32[8, 1536]"):
        ...
        _to_copy: "i64[8, 1536]" = torch.ops.aten._to_copy.default(primals_30, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=6));  primals_30 = None
        ...
        _to_copy_1: "b8[8, 1, 1536, 1536]" = torch.ops.aten._to_copy.default(primals_31, dtype = torch.bool, layout = torch.strided, device = device(type='cuda', index=6));  primals_31 = None
        
        # File: /opt/tiger/Megatron-LM/examples/simple_gpt.py:108 in forward_step_func, code: position_ids = data['position_ids'].to(device)
        _to_copy_2: "i64[8, 1536]" = torch.ops.aten._to_copy.default(primals_32, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=6));  primals_32 = None
        
        # File: /opt/tiger/Megatron-LM/examples/simple_gpt.py:109 in forward_step_func, code: labels = data['labels'].to(device)
        _to_copy_3: "i64[8, 1536]" = torch.ops.aten._to_copy.default(primals_33, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=6));  primals_33 = None
        
        # File: /opt/tiger/Megatron-LM/examples/simple_gpt.py:110 in forward_step_func, code: loss_mask = data['loss_mask'].to(device)
        _to_copy_4: "f32[8, 1536]" = torch.ops.aten._to_copy.default(primals_34, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=6));  primals_34 = None
        ...
        t_8: "f32[768, 12288]" = torch.ops.aten.t.default(primals_28);  primals_28 = None
        view_42: "f32[12288, 768]" = torch.ops.aten.view.default(wait_tensor_9, [12288, 768]);  wait_tensor_9 = None
        mm_8: "f32[12288, 12288]" = torch.ops.aten.mm.default(view_42, t_8);  view_42 = t_8 = None
        view_43: "f32[1536, 8, 12288]" = torch.ops.aten.view.default(mm_8, [1536, 8, 12288]);  mm_8 = None
        ...
        all_reduce_1: "f32[1536, 8]" = torch.ops._c10d_functional.all_reduce.default(getitem_35, 'max', '42')
        ...
        clone_6: "f32[1536, 8, 12288]" = torch.ops.aten.clone.default(view_43);  view_43 = None
        unsqueeze_1: "f32[1536, 8, 1]" = torch.ops.aten.unsqueeze.default(copy_5, -1);  copy_5 = None
        sub_1: "f32[1536, 8, 12288]" = torch.ops.aten.sub.Tensor(clone_6, unsqueeze_1);  clone_6 = unsqueeze_1 = None
        lt_1: "b8[1536, 8]" = torch.ops.aten.lt.Scalar(clone_5, 73728)
        ge_1: "b8[1536, 8]" = torch.ops.aten.ge.Scalar(clone_5, 86016)
        ...
        view_46: "f32[12288, 12288]" = torch.ops.aten.view.default(sub_1, [-1, 12288])
        ...
        copy_6: "f32[1536, 8, 12288]" = torch.ops.aten.copy.default(sub_1, exp);  sub_1 = exp = None
        sum_1: "f32[1536, 8]" = torch.ops.aten.sum.dim_IntList(copy_6, [-1])
        all_reduce_2: "f32[1536, 8]" = torch.ops._c10d_functional.all_reduce.default(view_50, 'sum', '42')
