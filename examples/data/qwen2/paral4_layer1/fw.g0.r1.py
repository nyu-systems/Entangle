...
class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "i64[32768]", arg1_1: "bf16[37984, 1536]", arg2_1: "bf16[1536]", arg3_1: "bf16[640]", arg4_1: "bf16[640, 1536]", arg5_1: "bf16[32768, 128]", arg6_1: "i64[32768]", arg7_1: "bf16[1536, 384]", arg8_1: "bf16[1536]", arg9_1: "bf16[4480, 1536]", arg10_1: "bf16[1536, 2240]", arg11_1: "bf16[1536]"):
        ...
        ge: "b8[32768]" = torch.ops.aten.ge.Scalar(arg0_1, 37984)
        ...
        lt: "b8[32768]" = torch.ops.aten.lt.Scalar(arg0_1, 75968)
        ...
        mul: "i64[32768]" = torch.ops.aten.mul.Tensor(bitwise_and, 37984)
        ...
        mul_1: "i64[32768]" = torch.ops.aten.mul.Tensor(bitwise_and_1, 113952)
        ...
        t: "bf16[1536, 640]" = torch.ops.aten.t.default(arg4_1);  arg4_1 = None
        addmm: "bf16[32768, 640]" = torch.ops.aten.addmm.default(arg3_1, getitem_1, t);  arg3_1 = getitem_1 = t = None
        ...
        split_with_sizes = torch.ops.aten.split_with_sizes.default(addmm, [384, 128, 128], -1)
        getitem_2: "bf16[32768, 384]" = split_with_sizes[0]
        ...
        getitem_6: "bf16[32768, 384]" = auto_functionalized_1[1]
        getitem_7: "bf16[32768, 128]" = auto_functionalized_1[2];  auto_functionalized_1 = None
        slice_scatter: "bf16[32768, 640]" = torch.ops.aten.slice_scatter.default(addmm, getitem_6, 1, 0, 384);  addmm = getitem_6 = None
        slice_scatter_1: "bf16[32768, 640]" = torch.ops.aten.slice_scatter.default(slice_scatter, getitem_7, 1, 384, 512);  slice_scatter = getitem_7 = None
        
         # File: /opt/tiger/vllm/vllm/attention/layer.py:167 in forward, code: output = torch.empty_like(query)
        split_with_sizes_3 = torch.ops.aten.split_with_sizes.default(slice_scatter_1, [384, 128, 128], -1)
        getitem_14: "bf16[32768, 384]" = split_with_sizes_3[0];  split_with_sizes_3 = None
        empty_like_1: "bf16[32768, 384]" = torch.ops.aten.empty_like.default(getitem_14, pin_memory = False);  getitem_14 = None
        
         # File: /opt/tiger/vllm/vllm/attention/layer.py:173 in forward, code: output = output.view(-1, self.num_heads, self.head_size)
        view_1: "bf16[32768, 3, 128]" = torch.ops.aten.view.default(empty_like_1, [-1, 3, 128]);  empty_like_1 = None
        
         # File: /opt/tiger/vllm/vllm/attention/layer.py:190 in forward, code: torch.ops.vllm.unified_attention_with_output(
        split_with_sizes_4 = torch.ops.aten.split_with_sizes.default(slice_scatter_1, [384, 128, 128], -1)
        getitem_17: "bf16[32768, 384]" = split_with_sizes_4[0];  split_with_sizes_4 = None
        view_4: "bf16[32768, 3, 128]" = torch.ops.aten.view.default(getitem_17, [-1, 3, 128]);  getitem_17 = None
        split_with_sizes_5 = torch.ops.aten.split_with_sizes.default(slice_scatter_1, [384, 128, 128], -1)
        ...
        split_with_sizes_6 = torch.ops.aten.split_with_sizes.default(slice_scatter_1, [384, 128, 128], -1);  slice_scatter_1 = None
        ...
        getitem_27: "bf16[32768, 3, 128]" = auto_functionalized_2[1];  auto_functionalized_2 = None
        view_7: "bf16[32768, 384]" = torch.ops.aten.view.default(getitem_27, [32768, 384]);  getitem_27 = None
        
         # File: /opt/tiger/vllm/vllm/model_executor/layers/linear.py:142 in apply, code: return F.linear(x, layer.weight, bias)
        t_1: "bf16[384, 1536]" = torch.ops.aten.t.default(arg7_1);  arg7_1 = None
        view_10: "bf16[32768, 3, 128]" = torch.ops.aten.view.default(view_7, [-1, 3, 128]);  view_7 = None
        view_11: "bf16[32768, 384]" = torch.ops.aten.view.default(view_10, [-1, 384]);  view_10 = None
        ...
        getitem_30: "bf16[32768, 1536]" = auto_functionalized_3[2];  auto_functionalized_3 = None
         ...
         # File: /opt/tiger/vllm/vllm/model_executor/layers/linear.py:142 in apply, code: return F.linear(x, layer.weight, bias)
        t_2: "bf16[1536, 4480]" = torch.ops.aten.t.default(arg9_1);  arg9_1 = None
        mm_1: "bf16[32768, 4480]" = torch.ops.aten.mm.default(getitem_29, t_2);  getitem_29 = t_2 = None
        ...
        empty: "bf16[32768, 2240]" = torch.ops.aten.empty.memory_format([32768, 2240], dtype = torch.bfloat16, device = device(type='cuda', index=1), pin_memory = False)
        ...
        getitem_32: "bf16[32768, 2240]" = auto_functionalized_4[1];  auto_functionalized_4 = None
        
         # File: /opt/tiger/vllm/vllm/model_executor/layers/linear.py:142 in apply, code: return F.linear(x, layer.weight, bias)
        t_3: "bf16[2240, 1536]" = torch.ops.aten.t.default(arg10_1);  arg10_1 = None
