...
class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "i64[32768]", arg1_1: "bf16[37984, 1536]", arg2_1: "bf16[1536]", arg3_1: "bf16[640]", arg4_1: "bf16[640, 1536]", arg5_1: "bf16[32768, 128]", arg6_1: "i64[32768]", arg7_1: "bf16[1536, 384]", arg8_1: "bf16[1536]", arg9_1: "bf16[4480, 1536]", arg10_1: "bf16[1536, 2240]", arg11_1: "bf16[1536]"):
        ...
        ge: "b8[32768]" = torch.ops.aten.ge.Scalar(arg0_1, 0)
        ...
        lt: "b8[32768]" = torch.ops.aten.lt.Scalar(arg0_1, 37984)
        ...
        mul: "i64[32768]" = torch.ops.aten.mul.Tensor(bitwise_and, 0)
        ...
        empty: "bf16[32768, 2240]" = torch.ops.aten.empty.memory_format([32768, 2240], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
