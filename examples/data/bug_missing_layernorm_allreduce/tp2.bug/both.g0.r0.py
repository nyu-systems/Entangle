...
class joint_helper(torch.nn.Module):
    def forward(self, primals, tangents):
        ...
        slice_1: "f16[512, 32, 1536]" = torch.ops.aten.slice.Tensor(clone_21, 0, 0, 512);  clone_21 = None
        ...
        empty_1: "f16[512, 32, 1536]" = torch.ops.aten.empty.memory_format([512, 32, 1536], dtype = torch.float16, device = device(type='cuda', index=0), pin_memory = False)
        ...
        lt_1: "b8[1024, 32]" = torch.ops.aten.lt.Scalar(clone_26, 0)
        ge_1: "b8[1024, 32]" = torch.ops.aten.ge.Scalar(clone_26, 49152)
        ...
        sub_2: "i64[1024, 32]" = torch.ops.aten.sub.Tensor(clone_27, 0);  clone_27 = None
        ...
        all_reduce_4: "f32[1]" = torch.ops._c10d_functional.all_reduce.default(detach_20, 'sum', '1')
        ...
        detach_26: "f32[1]" = torch.ops.aten.detach.default(detach_25);  detach_25 = None
         ...
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:170 in all_reduce, code: tensor = torch.ops._c10d_functional.all_reduce(self, reduceOp.lower(), group_name)
        all_reduce_5: "f32[1]" = torch.ops._c10d_functional.all_reduce.default(detach_23, 'sum', '1')
