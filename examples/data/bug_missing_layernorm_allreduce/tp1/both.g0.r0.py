...
class joint_helper(torch.nn.Module):
    def forward(self, primals, tangents):
        ...
        add_6: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(add_3, add_5);  add_5 = None
         ...
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/mappings.py:477 in copy_to_tensor_model_parallel_region, code: return _CopyToModelParallelRegion.apply(input_)
        view_21: "f16[1024, 32, 1536]" = torch.ops.aten.view.default(add_6, [1024, 32, 1536]);  add_6 = None
        ...
        view_25: "f32[32768, 98304]" = torch.ops.aten.view.default(sub, [-1, 98304])
        view_26: "i64[32768]" = torch.ops.aten.view.default(index_put, [-1]);  index_put = None
        ...
        clone_28: "f32[1]" = torch.ops.aten.clone.default(view_35)
        ...
        clone_29: "f32[1]" = torch.ops.aten.clone.default(view_33)
        ...
        clone_30: "f32[1]" = torch.ops.aten.clone.default(view_33);  view_33 = None
        ...
        mm_7: "f16[32768, 6144]" = torch.ops.aten.mm.default(view_47, getitem_33);  view_47 = None
        ...
        mm_11: "f16[32768, 1536]" = torch.ops.aten.mm.default(view_55, getitem_9);  view_55 = None
        ...
        fused_layer_norm_affine_bwd_1 = torch.ops.apex.fused_layer_norm_affine_bwd.default(view_67, detach_40, detach_42, clone_22, [48], getitem_21, getitem_23, 1e-05);  view_67 = detach_40 = detach_42 = clone_22 = None
        ...
        fused_layer_norm_affine_bwd_2 = torch.ops.apex.fused_layer_norm_affine_bwd.default(view_68, detach_44, detach_46, clone_21, [48], getitem_17, getitem_19, 1e-05);  view_68 = detach_44 = detach_46 = clone_21 = None
