...
class joint_helper(torch.nn.Module):
    def forward(self, primals, tangents):
        ...
        sub: "i64[32, 1024]" = torch.ops.aten.sub.Tensor(clone_20, 0);  clone_20 = None
        ...
        clone_21: "f16[1024, 32, 1536]" = torch.ops.aten.clone.default(transpose, memory_format = torch.contiguous_format);  transpose = None
         ...
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/_library/custom_ops.py:675 in __call__, code: return self._opoverload(*args, **kwargs)
        fused_layer_norm_affine_fwd = torch.ops.apex.fused_layer_norm_affine_fwd.default(clone_21, getitem_5, getitem_7, [1536], 1e-05)
        ...
        view_2: "f16[32768, 1536]" = torch.ops.aten.view.default(getitem_40, [32768, 1536])
        ...
        clone_22: "f16[1024, 32, 16, 48]" = torch.ops.aten.clone.default(view_4, memory_format = torch.contiguous_format);  view_4 = None
        ...
        clone_23: "f16[1024, 32, 16, 48]" = torch.ops.aten.clone.default(getitem_44, memory_format = torch.contiguous_format);  getitem_44 = None
        ...
        clone_24: "f16[1024, 32, 16, 48]" = torch.ops.aten.clone.default(permute, memory_format = torch.contiguous_format);  permute = None
        ...
        view_14: "f16[1024, 32, 768]" = torch.ops.aten.view.default(clone_24, [1024, 32, 768]);  clone_24 = None
        ...
        _unsafe_view_1: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(mm_1, [1024, 32, 1536]);  mm_1 = None
         ...
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/mappings.py:482 in reduce_from_tensor_model_parallel_region, code: return _ReduceFromModelParallelRegion.apply(input_)
        all_reduce_1: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.all_reduce.default(_unsafe_view_1, 'sum', '12')
        wait_tensor_6: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_1);  all_reduce_1 = None
        copy_1: "f16[1024, 32, 1536]" = torch.ops.aten.copy.default(_unsafe_view_1, wait_tensor_6);  _unsafe_view_1 = wait_tensor_6 = None
        _unsafe_view_2: "f16[32768, 1536]" = torch.ops.aten._unsafe_view.default(copy_1, [32768, 1536]);  copy_1 = None
        ...
        _unsafe_view_4: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(_unsafe_view_2, [1024, 32, 1536]);  _unsafe_view_2 = None
        view_17: "f16[1024, 32, 1536]" = torch.ops.aten.view.default(_unsafe_view_4, [1024, 32, 1536]);  _unsafe_view_4 = None
        add_2: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(view_17, getitem_11);  view_17 = None
        ...
        add_3: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(clone_21, add_2);  add_2 = None
        ...
        detach_17: "f32[32768]" = torch.ops.aten.detach.default(detach_16);  detach_16 = None
         ...
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_18: "f16[32768, 1536]" = torch.ops.aten.view.default(getitem_52, [32768, 1536])
        t_5: "f16[1536, 3072]" = torch.ops.aten.t.default(getitem_29)
        mm_2: "f16[32768, 3072]" = torch.ops.aten.mm.default(view_18, t_5);  view_18 = t_5 = None
        _unsafe_view_5: "f16[1024, 32, 3072]" = torch.ops.aten._unsafe_view.default(mm_2, [1024, 32, 3072]);  mm_2 = None
        ...
        add_4: "f16[1024, 32, 3072]" = torch.ops.aten.add.Tensor(_unsafe_view_5, getitem_31);  _unsafe_view_5 = None
        ...
        gelu: "f16[1024, 32, 3072]" = torch.ops.aten.gelu.default(add_4)
         ...
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_19: "f16[32768, 3072]" = torch.ops.aten.view.default(gelu, [32768, 3072])
        ...
        _unsafe_view_6: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(mm_3, [1024, 32, 1536]);  mm_3 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/mappings.py:482 in reduce_from_tensor_model_parallel_region, code: return _ReduceFromModelParallelRegion.apply(input_)
        all_reduce_2: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.all_reduce.default(_unsafe_view_6, 'sum', '12')
        wait_tensor_7: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_2);  all_reduce_2 = None
        copy_2: "f16[1024, 32, 1536]" = torch.ops.aten.copy.default(_unsafe_view_6, wait_tensor_7);  _unsafe_view_6 = wait_tensor_7 = None
        _unsafe_view_7: "f16[32768, 1536]" = torch.ops.aten._unsafe_view.default(copy_2, [32768, 1536]);  copy_2 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/fusions/fused_bias_dropout.py:33 in _bias_dropout_add_func, code: x = x + bias
        _unsafe_view_9: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(_unsafe_view_7, [1024, 32, 1536]);  _unsafe_view_7 = None
        view_21: "f16[1024, 32, 1536]" = torch.ops.aten.view.default(_unsafe_view_9, [1024, 32, 1536]);  _unsafe_view_9 = None
        add_5: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(view_21, getitem_35);  view_21 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/fusions/fused_bias_dropout.py:38 in _bias_dropout_add_func, code: out = residual + out
        add_6: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(add_3, add_5);  add_5 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_22: "f16[32768, 1536]" = torch.ops.aten.view.default(add_6, [32768, 1536])
        t_9: "f16[1536, 49152]" = torch.ops.aten.t.default(getitem_1)
        mm_4: "f16[32768, 49152]" = torch.ops.aten.mm.default(view_22, t_9);  view_22 = t_9 = None
        _unsafe_view_10: "f16[1024, 32, 49152]" = torch.ops.aten._unsafe_view.default(mm_4, [1024, 32, 49152]);  mm_4 = None
        ...
        clone_25: "i64[1024, 32]" = torch.ops.aten.clone.default(transpose_5, memory_format = torch.contiguous_format);  transpose_5 = None
        ...
        _to_copy_5: "f32[1024, 32, 49152]" = torch.ops.aten._to_copy.default(_unsafe_view_10, dtype = torch.float32);  _unsafe_view_10 = None
        max_1 = torch.ops.aten.max.dim(_to_copy_5, -1)
        getitem_55: "f32[1024, 32]" = max_1[0];  max_1 = None
        all_reduce_3: "f32[1024, 32]" = torch.ops._c10d_functional.all_reduce.default(getitem_55, 'max', '12')
        wait_tensor_8: "f32[1024, 32]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_3);  all_reduce_3 = None
        copy_3: "f32[1024, 32]" = torch.ops.aten.copy.default(getitem_55, wait_tensor_8);  getitem_55 = wait_tensor_8 = None
        ...
        lt_1: "b8[1024, 32]" = torch.ops.aten.lt.Scalar(clone_25, 0)
        ge_1: "b8[1024, 32]" = torch.ops.aten.ge.Scalar(clone_25, 49152)
        bitwise_or_1: "b8[1024, 32]" = torch.ops.aten.bitwise_or.Tensor(lt_1, ge_1);  lt_1 = ge_1 = None
        clone_26: "i64[1024, 32]" = torch.ops.aten.clone.default(clone_25);  clone_25 = None
        sub_2: "i64[1024, 32]" = torch.ops.aten.sub.Tensor(clone_26, 0);  clone_26 = None
        ...
        view_25: "f32[32768, 49152]" = torch.ops.aten.view.default(sub_1, [-1, 49152])
        view_26: "i64[32768]" = torch.ops.aten.view.default(index_put_2, [-1]);  index_put_2 = None
        index: "f32[32768]" = torch.ops.aten.index.Tensor(view_25, [arange, view_26]);  view_25 = arange = None
        clone_27: "f32[32768]" = torch.ops.aten.clone.default(index);  index = None
        view_27: "f32[1024, 32]" = torch.ops.aten.view.default(clone_27, [1024, 32]);  clone_27 = None
        ...
        index_put_3: "f32[1024, 32]" = torch.ops.aten.index_put.default(view_27, [bitwise_or_1], lift_fresh_copy_3);  view_27 = lift_fresh_copy_3 = None
        view_28: "f32[32768]" = torch.ops.aten.view.default(index_put_3, [32768]);  index_put_3 = None
        ...
        all_reduce_4: "f32[1024, 32]" = torch.ops._c10d_functional.all_reduce.default(view_29, 'sum', '12')
        wait_tensor_9: "f32[1024, 32]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_4);  all_reduce_4 = None
        copy_4: "f32[1024, 32]" = torch.ops.aten.copy.default(view_29, wait_tensor_9);  view_29 = wait_tensor_9 = None
        ...
        all_reduce_5: "f32[1024, 32]" = torch.ops._c10d_functional.all_reduce.default(sum_1, 'sum', '12')
        wait_tensor_10: "f32[1024, 32]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_5);  all_reduce_5 = None
        copy_5: "f32[1024, 32]" = torch.ops.aten.copy.default(sum_1, wait_tensor_10);  sum_1 = wait_tensor_10 = None
        log: "f32[1024, 32]" = torch.ops.aten.log.default(copy_5)
        sub_3: "f32[1024, 32]" = torch.ops.aten.sub.Tensor(log, view_31);  log = view_31 = None
        ...
        clone_28: "f32[32, 1024]" = torch.ops.aten.clone.default(transpose_6, memory_format = torch.contiguous_format);  transpose_6 = None
        ...
        view_34: "f32[32768]" = torch.ops.aten.view.default(clone_28, [-1]);  clone_28 = None
        ...
        clone_29: "f32[1]" = torch.ops.aten.clone.default(view_35)
        detach_18: "f32[1]" = torch.ops.aten.detach.default(clone_29);  clone_29 = None
        ...
        clone_30: "f32[1]" = torch.ops.aten.clone.default(view_33)
        detach_21: "f32[1]" = torch.ops.aten.detach.default(clone_30);  clone_30 = None
        ...
        all_reduce_6: "f32[1]" = torch.ops._c10d_functional.all_reduce.default(detach_20, 'sum', '1')
        
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:135 in wait_tensor, code: return torch.ops._c10d_functional.wait_tensor(tensor)  # type: ignore[attr-defined]
        wait_tensor_11: "f32[1]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_6);  all_reduce_6 = None
        ...
        copy_6: "f32[1]" = torch.ops.aten.copy.default(detach_20, wait_tensor_11);  detach_20 = wait_tensor_11 = None
        ...
        detach_26: "f32[1]" = torch.ops.aten.detach.default(detach_25);  detach_25 = None
         ...
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:170 in all_reduce, code: tensor = torch.ops._c10d_functional.all_reduce(self, reduceOp.lower(), group_name)
        all_reduce_7: "f32[1]" = torch.ops._c10d_functional.all_reduce.default(detach_23, 'sum', '1')
        
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:135 in wait_tensor, code: return torch.ops._c10d_functional.wait_tensor(tensor)  # type: ignore[attr-defined]
        wait_tensor_12: "f32[1]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_7);  all_reduce_7 = None
        
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:1112 in all_reduce_inplace, code: return tensor.copy_(all_reduce(tensor, op, group, tag))
        copy_7: "f32[1]" = torch.ops.aten.copy.default(detach_23, wait_tensor_12);  detach_23 = wait_tensor_12 = None
        ...
        clone_31: "f32[1]" = torch.ops.aten.clone.default(view_33);  view_33 = None
        detach_30: "f32[1]" = torch.ops.aten.detach.default(clone_31);  clone_31 = None
        ...
        mul_1: "f32[1]" = torch.ops.aten.mul.Tensor(view_35, 1);  view_35 = None
        ...
        index_put_4: "f32[32768, 49152]" = torch.ops.aten.index_put.default(view_40, [arange_1, view_26], sub_4);  view_40 = arange_1 = view_26 = sub_4 = None
        view_41: "f32[1024, 32, 49152]" = torch.ops.aten.view.default(index_put_4, [1024, 32, 49152]);  index_put_4 = None
        unsqueeze_4: "f32[1024, 32, 1]" = torch.ops.aten.unsqueeze.default(transpose_7, -1);  transpose_7 = None
        mul_4: "f32[1024, 32, 49152]" = torch.ops.aten.mul.Tensor(view_41, unsqueeze_4);  view_41 = unsqueeze_4 = None
        _to_copy_8: "f16[1024, 32, 49152]" = torch.ops.aten._to_copy.default(mul_4, dtype = torch.float16);  mul_4 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_43: "f16[32768, 49152]" = torch.ops.aten.view.default(_to_copy_8, [32768, 49152])
        mm_5: "f16[32768, 1536]" = torch.ops.aten.mm.default(view_43, getitem_1);  view_43 = None
        _unsafe_view_11: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(mm_5, [1024, 32, 1536]);  mm_5 = None
        view_44: "f16[32768, 49152]" = torch.ops.aten.view.default(_to_copy_8, [32768, 49152]);  _to_copy_8 = None
        view_45: "f16[32768, 1536]" = torch.ops.aten.view.default(add_6, [32768, 1536]);  add_6 = None
        t_10: "f16[49152, 32768]" = torch.ops.aten.t.default(view_44);  view_44 = None
        mm_6: "f16[49152, 1536]" = torch.ops.aten.mm.default(t_10, view_45);  t_10 = view_45 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        add_7: "f16[49152, 1536]" = torch.ops.aten.add.Tensor(tangents_1, mm_6);  tangents_1 = mm_6 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/fusions/fused_bias_dropout.py:33 in _bias_dropout_add_func, code: x = x + bias
        sum_4: "f16[1, 1, 1536]" = torch.ops.aten.sum.dim_IntList(_unsafe_view_11, [0, 1], True)
        ...
        add_8: "f16[1536]" = torch.ops.aten.add.Tensor(tangents_18, view_46);  tangents_18 = view_46 = None
         ...
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_47: "f16[32768, 1536]" = torch.ops.aten.view.default(_unsafe_view_11, [32768, 1536])
        mm_7: "f16[32768, 3072]" = torch.ops.aten.mm.default(view_47, getitem_33);  view_47 = None
        _unsafe_view_12: "f16[1024, 32, 3072]" = torch.ops.aten._unsafe_view.default(mm_7, [1024, 32, 3072]);  mm_7 = None
        view_48: "f16[32768, 1536]" = torch.ops.aten.view.default(_unsafe_view_11, [32768, 1536])
        view_49: "f16[32768, 3072]" = torch.ops.aten.view.default(gelu, [32768, 3072]);  gelu = None
        t_11: "f16[1536, 32768]" = torch.ops.aten.t.default(view_48);  view_48 = None
        mm_8: "f16[1536, 3072]" = torch.ops.aten.mm.default(t_11, view_49);  t_11 = view_49 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        add_9: "f16[1536, 3072]" = torch.ops.aten.add.Tensor(tangents_17, mm_8);  tangents_17 = mm_8 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/transformer/mlp.py:125 in forward, code: intermediate_parallel = self.activation_func(intermediate_parallel)
        gelu_backward: "f16[1024, 32, 3072]" = torch.ops.aten.gelu_backward.default(_unsafe_view_12, add_4);  _unsafe_view_12 = add_4 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/transformer/mlp.py:116 in forward, code: intermediate_parallel = intermediate_parallel + bias_parallel
        sum_5: "f16[1, 1, 3072]" = torch.ops.aten.sum.dim_IntList(gelu_backward, [0, 1], True)
        view_50: "f16[3072]" = torch.ops.aten.view.default(sum_5, [3072]);  sum_5 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/transformer/mlp.py:116 in forward, code: intermediate_parallel = intermediate_parallel + bias_parallel
        add_10: "f16[3072]" = torch.ops.aten.add.Tensor(tangents_16, view_50);  tangents_16 = view_50 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        view_51: "f16[32768, 3072]" = torch.ops.aten.view.default(gelu_backward, [32768, 3072])
        mm_9: "f16[32768, 1536]" = torch.ops.aten.mm.default(view_51, getitem_29);  view_51 = None
        _unsafe_view_13: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(mm_9, [1024, 32, 1536]);  mm_9 = None
        view_52: "f16[32768, 3072]" = torch.ops.aten.view.default(gelu_backward, [32768, 3072]);  gelu_backward = None
        view_53: "f16[32768, 1536]" = torch.ops.aten.view.default(getitem_52, [32768, 1536]);  getitem_52 = None
        all_reduce_8: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.all_reduce.default(_unsafe_view_13, 'sum', '12');  _unsafe_view_13 = None
        wait_tensor_13: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_8);  all_reduce_8 = None
        t_12: "f16[3072, 32768]" = torch.ops.aten.t.default(view_52);  view_52 = None
        mm_10: "f16[3072, 1536]" = torch.ops.aten.mm.default(t_12, view_53);  t_12 = view_53 = None
        ...
        fused_layer_norm_affine_bwd = torch.ops.apex.fused_layer_norm_affine_bwd.default(wait_tensor_13, detach_34, detach_36, add_3, [1536], getitem_25, getitem_27, 1e-05);  wait_tensor_13 = detach_34 = detach_36 = add_3 = None
        ...
        getitem_59: "f16[1536]" = fused_layer_norm_affine_bwd[2];  fused_layer_norm_affine_bwd = None
         ...
         # File: /dfs/scratch0/shirwu/anaconda3/envs/megatron/lib/python3.12/site-packages/torch/_library/custom_ops.py:675 in __call__, code: return self._opoverload(*args, **kwargs)
        add_12: "f16[1024, 32, 1536]" = torch.ops.aten.add.Tensor(_unsafe_view_11, getitem_57);  _unsafe_view_11 = getitem_57 = None
        ...
        mm_11: "f16[32768, 768]" = torch.ops.aten.mm.default(view_55, getitem_9);  view_55 = None
        _unsafe_view_14: "f16[1024, 32, 768]" = torch.ops.aten._unsafe_view.default(mm_11, [1024, 32, 768]);  mm_11 = None
        view_56: "f16[32768, 1536]" = torch.ops.aten.view.default(add_12, [32768, 1536])
        view_57: "f16[32768, 768]" = torch.ops.aten.view.default(view_14, [32768, 768]);  view_14 = None
        t_13: "f16[1536, 32768]" = torch.ops.aten.t.default(view_56);  view_56 = None
        mm_12: "f16[1536, 768]" = torch.ops.aten.mm.default(t_13, view_57);  t_13 = view_57 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/tensor_parallel/layers.py:697 in linear_with_grad_accumulation_and_async_allreduce, code: return LinearWithGradAccumulationAndAsyncCommunication.apply(*args)
        add_16: "f16[1536, 768]" = torch.ops.aten.add.Tensor(tangents_5, mm_12);  tangents_5 = mm_12 = None
        
         # File: /dfs/project/kgrlm/shirwu/hank/Megatron-LM/megatron/core/transformer/dot_product_attention.py:210 in forward, code: context = context.view(*new_context_shape)
        view_58: "f16[1024, 32, 16, 48]" = torch.ops.aten.view.default(_unsafe_view_14, [1024, 32, 16, 48]);  _unsafe_view_14 = None
        ...
        copy_8: "f16[512, 1024, 1024]" = torch.ops.aten.copy.default(new_empty_strided, view_62);  new_empty_strided = view_62 = None
        view_64: "f16[32, 16, 1024, 1024]" = torch.ops.aten.view.default(copy_8, [32, 16, 1024, 1024]);  copy_8 = None
        clone_32: "f16[32, 16, 1024, 1024]" = torch.ops.aten.clone.default(view_64, memory_format = torch.contiguous_format)
        masked_fill_1: "f16[32, 16, 1024, 1024]" = torch.ops.aten.masked_fill.Scalar(clone_32, wait_tensor_3, 0);  clone_32 = wait_tensor_3 = None
        copy_9: "f16[32, 16, 1024, 1024]" = torch.ops.aten.copy.default(view_64, masked_fill_1);  view_64 = masked_fill_1 = None
        view_65: "f16[512, 1024, 1024]" = torch.ops.aten.view.default(copy_9, [512, 1024, 1024]);  copy_9 = None
        ...
        fused_layer_norm_affine_bwd_1 = torch.ops.apex.fused_layer_norm_affine_bwd.default(view_67, detach_40, detach_42, clone_23, [48], getitem_21, getitem_23, 1e-05);  view_67 = detach_40 = detach_42 = clone_23 = None
        ...
        fused_layer_norm_affine_bwd_2 = torch.ops.apex.fused_layer_norm_affine_bwd.default(view_68, detach_44, detach_46, clone_22, [48], getitem_17, getitem_19, 1e-05);  view_68 = detach_44 = detach_46 = clone_22 = None
        ...
        _unsafe_view_15: "f16[1024, 32, 1536]" = torch.ops.aten._unsafe_view.default(mm_13, [1024, 32, 1536]);  mm_13 = None
        view_72: "f16[32768, 2304]" = torch.ops.aten.view.default(view_70, [32768, 2304]);  view_70 = None
        view_73: "f16[32768, 1536]" = torch.ops.aten.view.default(getitem_40, [32768, 1536]);  getitem_40 = None
        all_reduce_9: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.all_reduce.default(_unsafe_view_15, 'sum', '12');  _unsafe_view_15 = None
        wait_tensor_14: "f16[1024, 32, 1536]" = torch.ops._c10d_functional.wait_tensor.default(all_reduce_9);  all_reduce_9 = None
        t_14: "f16[2304, 32768]" = torch.ops.aten.t.default(view_72)
        mm_14: "f16[2304, 1536]" = torch.ops.aten.mm.default(t_14, view_73);  t_14 = view_73 = None
        ...
        fused_layer_norm_affine_bwd_3 = torch.ops.apex.fused_layer_norm_affine_bwd.default(wait_tensor_14, detach_48, detach_50, clone_21, [1536], getitem_5, getitem_7, 1e-05);  wait_tensor_14 = detach_48 = detach_50 = clone_21 = None
        ...
        index_put_5: "f16[32, 1024, 1536]" = torch.ops.aten.index_put.default(transpose_16, [bitwise_or], zeros_9);  transpose_16 = bitwise_or = zeros_9 = None
